...
;(println "min mongolabs-build"  mongolabs-config "dd" (get mongolabs-config :MONGODB_USER_PASS_URI) )
  (let [ 
  mongodb-user-pass-uri (get mongolabs-config :MONGODB_USER_PASS_URI) 
