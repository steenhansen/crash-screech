...
(ns tests-integration.html-render.get-index-test
...
;(def ^:const GET-INDEX-FILE "./test/tests_integration/html-render/get-index.html")
;(def ^:const GET-INDEX-FILE "./tests_integration/html-render/get-index.html")
;(def ^:const GET-INDEX-FILE "./html-render/get-index.html")
(def ^:const GET-INDEX-FILE "./get-index.html")
